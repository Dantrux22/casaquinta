...
const months = [
    {
      ...
      shifts: {
        day: [
          ...
          { day: "19", status: "reserved" }, { day: "20", status: "reserved" }, { day: "21", status: "reserved" },
          { day: "22", status: "reserved" }, { day: "23", status: "available" }, { day: "24", status: "reserved" },
          { day: "25", status: "reserved" }, { day: "26", status: "reserved" }, { day: "27", status: "reserved" },
          { day: "28", status: "reserved" }, { day: "29", status: "reserved" }, { day: "30", status: "reserved" },
    ...
    },
    {
        ...
        shifts: {
          day: [
            { day: "1", status: "reserved" }, { day: "2", status: "reserved" }, { day: "3", status: "reserved" },
            { day: "4", status: "reserved" }, { day: "5", status: "reserved" }, { day: "6", status: "reserved" },
            { day: "7", status: "available" }, { day: "8", status: "reserved" }, { day: "9", status: "reserved" },
            { day: "10", status: "reserved" }, { day: "11", status: "reserved" }, { day: "12", status: "available" },
            { day: "13", status: "available" }, { day: "14", status: "available" }, { day: "15", status: "reserved" },
            { day: "16", status: "reserved" }, { day: "17", status: "reserved" }, { day: "18", status: "available" },
            { day: "19", status: "available" }, { day: "20", status: "reserved" }, { day: "21", status: "reserved" },
      ...
      },
      {
        ...
        shifts: {
          day: [
            { day: "1", status: "reserved" }, { day: "2", status: "reserved" }, { day: "3", status: "available" },
            { day: "4", status: "available" }, { day: "5", status: "available" }, { day: "6", status: "available" },
            { day: "7", status: "available" }, { day: "8", status: "available" }, { day: "9", status: "available" },
            { day: "10", status: "available" }, { day: "11", status: "available" }, { day: "12", status: "available" },
            { day: "13", status: "available" }, { day: "14", status: "available" }, { day: "15", status: "available" },
